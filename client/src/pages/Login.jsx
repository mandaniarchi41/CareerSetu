...
import { User, Lock, ArrowRight, ArrowLeft, LineChart, BrainCircuit, BarChart, BookOpen } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-8 sm:px-16 relative bg-[#0B0D19]">
        ...
        <div className="w-full max-w-[360px] relative z-10">
          ...
          <div className="flex p-1 bg-[#131527] rounded-full border border-white/5 mb-14 max-w-[200px] mx-auto">
            ...
            <Link to="/signup" className="flex-1 py-2 rounded-full text-slate-400 hover:text-white font-bold text-sm text-center transition-colors">
              Sign Up
            </Link>
          </div>

          <div className="mb-10 text-center sm:text-left">
            <h2 className="text-[2rem] font-black text-white mb-2 tracking-tight">Welcome back</h2>
            <p className="text-slate-400 text-sm">Sign in to access your career pathway</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-[11px] font-bold text-slate-400 tracking-widest uppercase ml-1">USERNAME</label>
          ...
          <p className="text-center mt-8 text-slate-500 text-sm">
            ...
            <Link to="/signup" className="text-blue-400 font-bold hover:text-blue-300 transition-colors underline underline-offset-4">Sign Up</Link>
          </p>
